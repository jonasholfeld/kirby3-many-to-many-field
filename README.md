...
<span style="color:rd">Please update to v1.0.2 if you used the plugin before, as the old version contained a bug that could lead to data-loss. See the issue [Sorting Structure](https://github.com/jonasholfeld/kirby3-many-to-many-field/issues/7) for more info on the bug.</span>
